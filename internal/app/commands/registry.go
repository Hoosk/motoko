...
var commandDefinitions = []Definition{
	...
	{Name: "learn", Usage: "/learn", Summary: "Capture reusable project knowledge as a skill or subagent"},
	{Name: "teamwork-preview", Usage: "/teamwork-preview [goal]", Summary: "Parallel planning with subagents and optional build handoff"},
